...
The 3B was ruled out on heat and size. So the choice is: swap to Qwen and lose the
personality, accept the 1B, or teach a small model to do both. That last one is this
document.
...
## 1. It does not need your laptop for two days
...
## 2. What it has to learn — both halves
...
- **Qwen3 0.6B has a thinking mode.** Disable it in generation or reasoning traces will
